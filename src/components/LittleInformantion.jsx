            ...
            <div className='container max-w-[1152px] mx-auto px-3'>
                <div className='flex flex-wrap justify-center'>
                    ...
                    <div className='lg:w-1/2 px-3 lg:px-0 relative'>
                        <h3 className='font-ClashDisplay text-2xl font-semibold mt-14 lg:mt-[141px] text-Rich-Black text-center lg:text-start'>A Little Information For Our Guest</h3>
                        <p className='text-sm font-normal mt-2 font-Syne text-Rich-Black opacity-70 text-center lg:text-start'>Dictum commodo pharetra sit odio nulla aliquam sit morbi. Nec dictum accumsan odio tellus integer scelerisque. Dictum commodo pharetra sit odio nulla aliquam sit mor diio tellus integer scelerisque.</p>
                        <div className='mt-6 md:mt-[40px] sm:flex gap-[24px] justify-center  lg:justify-start'>
                            <div className='py-[15px] px-[24px] rounded-[8px] shadow-[0px_3px_0px_0px_#000000] border-[1px] border-[#000000] mx-auto sm:mx-0 max-w-[267px] flex items-center'>
                            ...
                            <div className='py-[15px] px-[24px] mt-4 sm:mt-0 rounded-[8px] shadow-[0px_3px_0px_0px_#000000] border-[1px] border-[#000000] mx-auto sm:mx-0 max-w-[267px] flex items-center'>
