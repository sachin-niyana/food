...
const OurChef = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center mt-[30px] sm:mt-[60px] mb-[82px] md:mt-6 md:mb-10 lg:hidden  lg:mt-0">
        <ShowMoreBtn
          data={
            <div className="lg:hidden">
              <div className="flex flex-wrap lg:grid grid-cols-3 gap-6  items-center justify-center">
                {ourChef.slice(0, showOneCard ? 1 : 2).map((value, index) => (
                  <div
                    data-aos="zoom-in"
                    data-aos-easing="linear"
                    data-aos-duration="800"
