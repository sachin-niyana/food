      ...
      <div className="container max-w-[1152px] mx-auto px-3">
        <div className="flex flex-col lg:flex-row items-center lg:justify-between pb-10">
          ...
          <div className="mt-3 lg:mt-0">
            <button className="bg-linear-gradient-btn flex items-center transition-shadow duration-300 hover:shadow-buttonShadow font-ClashDisplay text-sm font-medium px-5 py-3 rounded-full gap-1.5">
              <RightArrow /> See All
            </button>
          </div>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-5 sm:gap-3 lg:gap-6">
          {ourChef.map((value, index) => (
            <div className="max-w-[364px]" key={index}>
              <div
