...
const Navbar = () => {
  ...
  return (
    <nav className="z-10 py-3.5 flex-grow-0">
      <div className="flex items-center justify-between container max-w-[1152px] mx-auto px-3 bg-white">
        <Image
            ...
            return (
              <li key={index}>
                <Link
                  ...
                  className="text-light-white text-opacity-70 hover:text-opacity-100 font-Syne font-normal sm:text-sm text-xsm transition-all ease-in-out duration-300"
                  key={index}
                  href={value.path}
                >
                  {value.title}
